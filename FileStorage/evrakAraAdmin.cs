...
{
    public partial class evrakAraAdmin : Form
    {
        public evrakAraAdmin()
        {
            InitializeComponent();
        ...
        public void ara()
        {
            ...
            string stm = "select * FROM evrakBilgi WHERE info1 LIKE '%" + arama + "%' or info2 LIKE '%" + arama + "%' or info3 LIKE '%" + arama + "%'  or info4 LIKE '%" + arama + "%' or info5 LIKE '%" + arama + "%'  or info6 LIKE '%" + arama + "%' or evrakAd LIKE '%" + arama + "%'";
            ...
            while (dr.Read())
            {
                dataGridView1.Rows.Insert(0, dr.GetValue(1).ToString(), dr.GetValue(2).ToString(), dr.GetValue(3).ToString(), dr.GetValue(4).ToString(), dr.GetValue(5).ToString(), dr.GetValue(6).ToString(), dr.GetValue(7).ToString(), dr.GetValue(8).ToString(), dr.GetValue(10).ToString(), dr.GetValue(11).ToString());
            }
            con.Close();
        }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                //
                textBox1.Text = y + "folder\\" + klasor + "\\" + dosya;
            }
        }
